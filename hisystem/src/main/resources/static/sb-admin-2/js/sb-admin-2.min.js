...
!function (t) {
    ...
    t("#sidebarToggle, #sidebarToggleTop").on("click", function (o) {
        t("body").toggleClass("sidebar-toggled"), t(".sidebar").toggleClass("toggled"), t("#content-wrapper").toggleClass("my-content-wrapper"), t(".sidebar").hasClass("toggled") && t(".sidebar .collapse").collapse("hide")
